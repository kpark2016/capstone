...
class CastingTestCase(unittest.TestCase):
    ...
    def test_patch_movies(self):
        ...
        res = self.client().patch('/movies', json=patch_movie, headers=self.header_director)
        data = json.loads(res.data)
    ...
    def test_patch_actors(self):
        ...
        res = self.client().patch('/actors', json=patch_actor, headers=self.header_director)
        data = json.loads(res.data)
